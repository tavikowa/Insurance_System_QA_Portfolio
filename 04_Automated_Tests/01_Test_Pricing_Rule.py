...
json_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '03_API_Test_Data', 'quote_request_kacper.json')
db_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'sql_script.db')
...
def run_test():
    try:
        ...
        print(f"Client ID from JSON: {my_client_id}")
